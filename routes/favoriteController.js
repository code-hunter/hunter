...
var favoriteService = new dbService(dbConfig.favorite);
...
router.get('/getPage', function (req, res, next) {
    try{
        ...
        result = {};
        favoriteService.count(q).then(function (ret) {
            result.total = ret;
            favoriteService.getPage(q, o).then(function(ret){
                result.docs = ret;
...
router.post('/save', function (req, res, next) {
    ...
    try{
        ...
        archiveService.getOne(q).then(function (ret) {
            ...
            favoriteService.save(doc).then(function (ret) {
...
router.post('/delete', function (req, res, next) {
    ...
    try{
        ...
        favoriteService.deleteMany(q).then(function (ret) {
            res.send(Json.success(ret));
        })
